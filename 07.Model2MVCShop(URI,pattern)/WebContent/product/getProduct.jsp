...
<body bgcolor="#ffffff" text="#000000">
	...
	<form name="detailForm" method="post">
						...
						<tr>
							<c:if test="${user.role=='admin' }">
								...
								<td background="/images/ct_btnbg02.gif" class="ct_btn01"
									...
									href="/product/updateProduct?prodNo=${product.prodNo}&menu=manage">
										수정 </a></td>
		...
		구매를 원하시면 로그인하세요.
							...
							<c:if test="${user.role=='admin'}">
								<td width="17" height="23"><img
									src="/images/ct_btnbg01.gif" width="17" height="23" />
								<td background="/images/ct_btnbg02.gif" class="ct_btn01"
									style="padding-top: 3px;"><a
									href="/product/listProduct?menu=search&orderby=${param.orderby }">확인</a>
								</td>
							</c:if>
							<c:if test="${user.role=='user' && product.proTranCode=='1'}">
								<td width="17" height="23"><img
									src="/images/ct_btnbg01.gif" width="17" height="23" /></td>
								<td background="/images/ct_btnbg02.gif" class="ct_btn01"
									style="padding-top: 3px;"><a
